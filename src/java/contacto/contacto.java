...
public class contacto extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(mailEnvio.send("contacto.trabajo.002@gmail.com","fer14Hq02fgrAh14BqnaJ2003",correo,mensajerespuesta, "Contacto de floramics")&&mailEnvio.send("contacto.trabajo.002@gmail.com","fer14Hq02fgrAh14BqnaJ2003","fernandoschifferkira@gmail.com",mensajeAdmin, "Te estan contactando")){
